...
from Pikachu import INSPECTOR, dispatcher
from Pikachu.Plugins.disable import DisableAbleCommandHandler
from Pikachu.Handlers.validation import (
    bot_admin,
    can_pin,
    can_promote,
    connection_status,
...
from Pikachu.Handlers.extraction import (
    extract_user,
    extract_user_and_text,
)
from Pikachu.Plugins.Admin.log_channel import loggable
from Pikachu.Handlers.alternate import send_message, typing_action
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("𝕷𝖔𝕷 𝖚 𝖉𝖔𝖓'𝖙 𝖍𝖆𝖇 𝖗𝖎𝖌𝖍𝖙 ◔◡◔")
        return
    ...
    if user_member.status == "administrator" or user_member.status == "creator":
        message.reply_text("HEHE already admin")
        return

    if user_id == bot.id:
        message.reply_text("Jai Ho")
        return
